...
object AdsColorManager {
    ...
    fun setColors(colors: Map<String, String>) {
        nativeAdTagTextColor = Color.parseColor(colors["headerTextColor"])
        textColorTitle = Color.parseColor(colors["headerTextColor"])
        nativeTextColorBody = Color.parseColor(colors["bodyTextColor"])
        nativeButtonColorStartColor = Color.parseColor(colors["btnBgColorStart"])
        nativeButtonColorEndColor = Color.parseColor(colors["btnBgColorEnd"])
        nativeButtonTextColor = Color.parseColor(colors["btnTextColor"])
        nativeAdTagBgStartColor = Color.parseColor(colors["btnBgColorStart"])
        nativeAdTagBgEndColor = Color.parseColor(colors["btnBgColorEnd"])
        nativeAdBgColor = Color.parseColor(colors["nativeBGColor"])
    }
}
